    ...
    <a
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow =
          '0 12px 32px rgba(37,211,102,0.55), 0 2px 6px rgba(0,0,0,0.15)'
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.transform = 'scale(1)'
        e.currentTarget.style.boxShadow =
          '0 8px 24px rgba(37,211,102,0.45), 0 2px 6px rgba(0,0,0,0.15)'
      }}
    >
      {/* Logo oficial do WhatsApp em SVG (fundo verde removido, usa do botão) */}
      <svg
